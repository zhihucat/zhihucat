...
import { createBattle, replayBattle, getCampaignLevels, getCampaignCase, demoCase, respondToDebate, buildVerdict } from './campaign.ts';
...
export type ServerOptions = { corsOrigin?: string };
