...
export const APP_COPY = {
  zh: {
    ...
    profileSavedLocal: '已保存到本机；本地练习成绩不会上传云端。',
    profileCloudUnavailable: '云端档案暂时不可用，仍可使用本机模式。',
    profileRunSavedLocal: '本局仅记录在本机，不会上传云端。',
    logoutError: '退出登录失败',
    ...
    authPasswordHelp: '新账号至少 8 位；已有账号使用原密码',
  ...
  en: {
    ...
    profileSavedLocal: 'Saved locally; practice scores are never uploaded.',
    profileCloudUnavailable: 'Cloud profile is temporarily unavailable; local mode is still ready.',
    profileRunSavedLocal: 'This run was saved locally only and will not be uploaded.',
    ...
    authPasswordHelp: 'New accounts: at least 8 characters. Existing accounts: original password.',
    ...
    authRegisterMessage: 'Email confirmation is enabled, but username accounts cannot receive email. Contact the administrator to fix Auth settings and this unconfirmed account.',
    ...
    authPasswordShort: 'New passwords need at least 8 characters. Use your full original password to log in.',
    ...
    authEmailUnconfirmed: 'Contact the administrator to confirm this account. Disabling confirmation does not confirm existing accounts.',
